...
function AdNavBar() {
    ...
    return (
        <Nav style={{ width: '100%', backgroundColor: '#4A4A4A', height: '100px', display: 'flex', alignItems: 'center', }}>
            <div style={{ width: '55%', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', height: '100%' }}>

                <img src={require('../../assets/Images/logo.png')} style={{ width: '25%', height: '70%', }} />
            ...
            <div style={{ width: '40%', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', float: 'left' }}>

                <NavItem >
                    <NavLink href="/Notify" style={{ color: 'white', fontSize: 14 }}>
                        <img src={require('../../assets/Images/bell_head.png')} style={{ width: '100%', height: '100%', }} />
                    </NavLink>
                </NavItem>


                <Dropdown isOpen={dropdownOpen} toggle={toggle} style={{ width: 30, marginTop: 5 }}>
